...
<main class="mb-14 w-full max-w-480 overflow-hidden lg:mb-0">
  <div class="pt-20">
    <AnimatedHeading
      frontText={{ firstText: "ABOUT", secondText: "ME" }}
      backText="RESUME"
    />
  </div>
  <div class="animation-slide-in-up">
    ...
    >
      ...
      >
        <div class="flex h-full w-full flex-col gap-4 lg:w-1/2">
          <h2 class="w-full py-2 text-start text-2xl text-[#5160b2]">
            PERSONAL INFO
          </h2>
    ...
    <section class="flex flex-col items-center justify-center">
      <div class="flex w-full items-center justify-center py-8">
        <h2
          data-aos="fade-down"
          class="mb-4 pt-12 text-2xl font-bold sm:py-0 sm:text-4xl"
        >
          MY SKILLS
        </h2>
      </div>
