    ...
    {#each experienceAndEducation as data (data.title)}
      <div class="experience-education flex h-full w-full gap-4 p-4 opacity-0">
        ...
        <div class="flex flex-col gap-2">
          <div
            class="w-fit rounded-full bg-[#bcc0cc] px-3 py-1 text-sm text-nowrap dark:bg-gray-700 dark:text-gray-200"
          >
            {data.duration}
          </div>
          ...
          <div>
            <ul
              class="flex list-disc flex-col text-sm text-gray-800 dark:text-gray-400"
            >
