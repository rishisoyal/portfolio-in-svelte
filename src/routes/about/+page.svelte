...
<main class="mb-14 w-full max-w-480 lg:mb-0 overflow-hidden">
  <div class="pt-20">
	...
	<div class="animation-slide-in-up">
		...
		>
			<div class="flex w-full min-[1600px]:w-360 flex-col items-start justify-center gap-2 p-3 lg:flex-row">
				<div
					class="flex h-full w-full flex-col gap-4 lg:w-1/2"
				>
