    ...
    <div class="flex w-full flex-col gap-4 py-1 md:flex-row lg:p-2">
      <ToolTipWrapper open={!!formError.name} tooltip={formError.name!}>
        <input
          ...
          class={`transition-border w-full rounded-full border-2 bg-gray-300 p-3 px-6 text-[12px] text-black duration-200 outline-none focus:border-[#5160b2] sm:py-4 sm:text-[14px] dark:bg-[#313244] dark:text-white ${formError.name === "" ? "border-[#d20f3982]" : "border-transparent"} cursor-input hover:scale-101 focus:scale-101 custom-cursor:cursor-none`}
        />
      </ToolTipWrapper>
      ...
      <ToolTipWrapper tooltip={formError.email!} open={!!formError.email}>
        <input
          ...
          class={`transition-border w-full rounded-full border-2 bg-gray-300 p-3 px-6 text-[12px] text-black duration-200 outline-none focus:border-[#5160b2] sm:py-4 sm:text-[14px] dark:bg-[#313244] dark:text-white ${formError.email === "" ? "border-[#d20f3982]" : "border-transparent"} cursor-input hover:scale-101 focus:scale-101 custom-cursor:cursor-none`}
        />
      </ToolTipWrapper>
    </div>
    ...
    <div class="w-full py-1 lg:p-2">
      <ToolTipWrapper tooltip={formError.message!} open={!!formError.message}>
        <textarea
          ...
          class={`transition-border min-h-40 w-full rounded-4xl border-2 bg-gray-300 p-3 px-6 text-[12px] text-black duration-200 outline-none focus:border-[#5160b2] sm:py-4 sm:text-[14px] dark:bg-[#313244] dark:text-white ${formError.message === "" ? "border-[#d20f3982]" : "border-transparent"} cursor-input hover:scale-101 focus:scale-101 custom-cursor:cursor-none`}
          rows={6}
          maxLength={500}
        ></textarea>
      </ToolTipWrapper>
